            ...
            <DeploymentFormWrapper>
              <FieldWrapper>
                ...
                <Field name="appName" id="appName">
                  {({ field }) => <InputField {...field} disabled={forbidEditing} placeholder="Optional. We will auto-generate one for you, if you don't provide a name." />}
                </Field>
              </FieldWrapper>
            </DeploymentFormWrapper>
            ...
            <div>
              ...
              {sdl.deployment &&
                Object.keys(sdl.deployment)?.map((serviceName, index) => {
                  ...
                  return (
                    <AppAccordion key={serviceName}>
                      <AccordionSummary expandIcon={<ExpandMoreIcon color="primary" />}>
                        <Typography sx={{ color: '#FA5757' }}>{capitalize(serviceName)}</Typography>
                      </AccordionSummary>
                      <AccordionDetails>
                        <div
                          style={{
